...
// RMSNorm with BF16-matching accumulation: the sum-of-squares reduction rounds
// to BF16 after each element addition to match HuggingFace/PyTorch behavior.
// The FP32 accumulator plus per-step BF16 rounding emulates BF16 storage.
