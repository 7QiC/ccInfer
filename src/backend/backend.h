...
public:
    ...
    // --- operator entry points (transitional: explicit runtime dtype; the
    //     final form will take ops::Tensor + ExecutionContext once ops
    //     migrate into the operator library) ---
