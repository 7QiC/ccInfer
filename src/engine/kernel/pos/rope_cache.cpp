...
void RopeCache::init(int max_position, int rotary_dim, float rope_theta) {
    if (max_position <= 0) return;
    if (rotary_dim <= 0 || rotary_dim % 2 != 0) return;
